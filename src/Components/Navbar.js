...
export default class Navbar extends Component {
  render() {
    return (
      <div>
        <nav className="navbar fixed-top navbar-expand-lg  bg-primary text-light py-2 px-5">
          <div className="container-fluid">
            <Link className="navbar-brand" to="/general">API-NEWS</Link>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li className="nav-item text-capitalize"><Link className="nav-link" to="/general">general</Link></li>
